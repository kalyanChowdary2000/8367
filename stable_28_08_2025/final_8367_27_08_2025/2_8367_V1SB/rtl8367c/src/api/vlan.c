...
rtk_api_ret_t rtk_vlan_set(rtk_vlan_t vid, rtk_vlan_cfg_t *pVlanCfg)
{
    rtk_api_ret_t retVal;
    uint32 phyMbrPmask;
    uint32 phyUntagPmask;
    rtl8367c_user_vlan4kentry vlan4K;
    rtl8367c_vlanconfiguser vlanMC;
    uint32 idx;
    uint32 empty_index = 0xffff;
    uint32 update_evid = 0;
...
rtk_api_ret_t rtk_vlan_egrFilterEnable_set(rtk_enable_t egrFilter)
{
    ...
    /* enable VLAN */
    if ((retVal = rtl8367c_setAsicVlanFilter((uint32)egrFilter)) != RT_ERR_OK)
        return retVal;
 ...
 *     Set a VLAN Member Configuration entry by index.
 */
rtk_api_ret_t rtk_vlan_mbrCfg_set(uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg)
{
    rtk_api_ret_t           retVal;
    uint32              phyMbrPmask;
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
rtk_api_ret_t rtk_vlan_mbrCfg_get(uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg)
{
    rtk_api_ret_t           retVal;
    uint32              phyMbrPmask;
    rtl8367c_vlanconfiguser mbrCfg;
...
rtk_api_ret_t rtk_vlan_UntagDscpPriorityEnable_set(rtk_enable_t enable)
{
    ...
    if ((retVal = rtl8367c_setAsicVlanUntagDscpPriorityEn((uint32)enable)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t rtk_vlan_checkAndCreateMbr(rtk_vlan_t vid, uint32 *pIndex)
{
    rtk_api_ret_t retVal;
    rtl8367c_user_vlan4kentry vlan4K;
    rtl8367c_vlanconfiguser vlanMC;
...
rtk_api_ret_t rtk_vlan_reservedVidAction_set(rtk_vlan_resVidAction_t action_vid0, rtk_vlan_resVidAction_t action_vid4095)
{
    ...
    if ((retVal = rtl8367c_setReservedVidAction((uint32)action_vid0, (uint32)action_vid4095)) != RT_ERR_OK)
        return retVal;
...
rtk_api_ret_t rtk_vlan_reservedVidAction_get(rtk_vlan_resVidAction_t *pAction_vid0, rtk_vlan_resVidAction_t *pAction_vid4095)
{
    ...
    if ((retVal = rtl8367c_getReservedVidAction((uint32 *)pAction_vid0, (uint32 *)pAction_vid4095)) != RT_ERR_OK)
        return retVal;
...
rtk_api_ret_t rtk_vlan_realKeepRemarkEnable_set(rtk_enable_t enabled)
{
    ...
    if ((retVal = rtl8367c_setRealKeepRemarkEn((uint32)enabled)) != RT_ERR_OK)
        return retVal;
...
rtk_api_ret_t rtk_vlan_realKeepRemarkEnable_get(rtk_enable_t *pEnabled)
{
    ...
    if ((retVal = rtl8367c_getRealKeepRemarkEn((uint32 *)pEnabled)) != RT_ERR_OK)
        return retVal;
