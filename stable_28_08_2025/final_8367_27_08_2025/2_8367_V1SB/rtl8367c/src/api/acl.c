 ...
 */
rtk_api_ret_t rtk_filter_igrAcl_field_sel_set(uint32 index, rtk_field_sel_t format, uint32 offset)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t rtk_filter_igrAcl_field_sel_get(uint32 index, rtk_field_sel_t *pFormat, uint32 *pOffset)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t rtk_filter_iprange_set(uint32 index, rtk_filter_iprange_t type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t rtk_filter_iprange_get(uint32 index, rtk_filter_iprange_t *pType, ipaddr_t *pUpperIp, ipaddr_t *pLowerIp)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t rtk_filter_vidrange_set(uint32 index, rtk_filter_vidrange_t type, uint32 upperVid, uint32 lowerVid)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t rtk_filter_vidrange_get(uint32 index, rtk_filter_vidrange_t *pType, uint32 *pUpperVid, uint32 *pLowerVid)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t rtk_filter_portrange_set(uint32 index, rtk_filter_portrange_t type, uint32 upperPort, uint32 lowerPort)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t rtk_filter_portrange_get(uint32 index, rtk_filter_portrange_t *pType, uint32 *pUpperPort, uint32 *pLowerPort)
{
    rtk_api_ret_t ret;
 ...
 *      none
 */
rtk_api_ret_t rtk_filter_igrAclPolarity_set(uint32 polarity)
{
    /* Check initialization state */
    RTK_CHK_INIT_STATE();
 ...
 *      none
 */
rtk_api_ret_t rtk_filter_igrAclPolarity_get(uint32* pPolarity)
{
    /* Check initialization state */
    RTK_CHK_INIT_STATE();
