 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeter(uint32 index, uint32 rate, uint32 ifg)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeter(uint32 index, uint32 *pRate, uint32 *pIfg)
{
    uint32 regData;
    uint32 regData2;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeterBucketSize(uint32 index, uint32 lbthreshold)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeterBucketSize(uint32 index, uint32 *pLbthreshold)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicShareMeterType(uint32 index, uint32 type)
{
    uint32 reg;
 ...
 *      None
 */
ret_t rtl8367c_getAsicShareMeterType(uint32 index, uint32 *pType)
{
    uint32 reg;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMeterExceedStatus(uint32 index)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
 ...
 */
ret_t rtl8367c_getAsicMeterExceedStatus(uint32 index, uint32* pStatus)
{
    if(index > RTL8367C_METERMAX)
        return RT_ERR_FILTER_METER_ID;
