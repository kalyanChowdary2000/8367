 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIngressBandwidth(uint32 port, uint32 bandwidth, uint32 preifg, uint32 enableFC)
{
    ret_t retVal;
    uint32 regData;
    uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIngressBandwidth(uint32 port, uint32* pBandwidth, uint32* pPreifg, uint32* pEnableFC)
{
    ret_t retVal;
    uint32 regData;
    uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIngressBandwidthBypass(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIngressBandwidthBypass(uint32* pEnabled)
{
