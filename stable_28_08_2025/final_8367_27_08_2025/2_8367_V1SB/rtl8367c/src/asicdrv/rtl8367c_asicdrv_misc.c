 ...
 *      None
 */
ret_t rtl8367c_getAsicDebugInfo(uint32 port, uint32 *pDebugifo)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortJamMode(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortJamMode(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMaxLengthCfg(uint32 cfgId, uint32 maxLength)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMaxLengthCfg(uint32 cfgId, uint32 *pMaxLength)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMaxLength(uint32 port, uint32 type, uint32 cfgId)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMaxLength(uint32 port, uint32 type, uint32 *pCfgId)
{
    ret_t retVal;
