...
#if 0
static void _rtl8367c_svlanConfStUser2Smi( rtl8367c_svlan_memconf_t *pUserSt, uint16 *pSmiSt)
{
...
#endif
static void _rtl8367c_svlanConfStSmi2User( rtl8367c_svlan_memconf_t *pUserSt, uint16 *pSmiSt)
{
...
#if 0
static void _rtl8367c_svlanMc2sStUser2Smi(rtl8367c_svlan_mc2s_t *pUserSt, uint16 *pSmiSt)
{
    pSmiSt[0] |= (pUserSt->svidx & 0x003F);
    pSmiSt[0] |= (pUserSt->format & 0x0001) << 6;
    pSmiSt[0] |= (pUserSt->valid & 0x0001) << 7;

    pSmiSt[1] = (uint16)(pUserSt->smask & 0x0000FFFF);
    pSmiSt[2] = (uint16)((pUserSt->smask & 0xFFFF0000) >> 16);

    pSmiSt[3] = (uint16)(pUserSt->sdata & 0x0000FFFF);
    pSmiSt[4] = (uint16)((pUserSt->sdata & 0xFFFF0000) >> 16);
}

static void _rtl8367c_svlanMc2sStSmi2User(rtl8367c_svlan_mc2s_t *pUserSt, uint16 *pSmiSt)
{
...
static void _rtl8367c_svlanSp2cStUser2Smi(rtl8367c_svlan_s2c_t *pUserSt, uint16 *pSmiSt)
{
...
static void _rtl8367c_svlanSp2cStSmi2User(rtl8367c_svlan_s2c_t *pUserSt, uint16 *pSmiSt)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUplinkPortMask(uint32 portMask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUplinkPortMask(uint32* pPortmask)
{
 ...
 */
ret_t rtl8367c_setAsicSvlanTpid(uint32 protocolType)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanTpid(uint32* pProtocolType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanPrioritySel(uint32 priSel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanPrioritySel(uint32* pPriSel)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanTrapPriority(uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanTrapPriority(uint32* pPriority)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanDefaultVlan(uint32 port, uint32 index)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanDefaultVlan(uint32 port, uint32* pIndex)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanIngressUntag(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanIngressUntag(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanIngressUnmatch(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanIngressUnmatch(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanEgressUnassign(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanEgressUnassign(uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanMemberConfiguration(uint32 index, rtl8367c_svlan_memconf_t* pSvlanMemCfg)
{
    ret_t retVal;
    uint32 regAddr, regData;
    uint16 *accessPtr;
    uint32 i;
    uint16 smiSvlanMemConf[RTL8367C_SVLAN_MEMCONF_LEN];

    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;

    memset(smiSvlanMemConf, 0x00, sizeof(uint16) * RTL8367C_SVLAN_MEMCONF_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanMemberConfiguration(uint32 index,rtl8367c_svlan_memconf_t* pSvlanMemCfg)
{
    ret_t retVal;
    uint32 regAddr,regData;
    uint16 *accessPtr;
 ...
 */
ret_t rtl8367c_setAsicSvlanC2SConf(uint32 index, uint32 evid, uint32 portmask, uint32 svidx)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanC2SConf(uint32 index, uint32* pEvid, uint32* pPortmask, uint32* pSvidx)
{
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicSvlanMC2SConf(uint32 index,rtl8367c_svlan_mc2s_t* pSvlanMc2sCfg)
{
    ret_t retVal;
    uint32 regData;
    uint16 *accessPtr;
    uint32 i;
    uint16 smiSvlanMC2S[RTL8367C_SVLAN_MC2S_LEN];

    if(index > RTL8367C_MC2SIDXMAX)
        return RT_ERR_ENTRY_INDEX;

    memset(smiSvlanMC2S, 0x00, sizeof(uint16) * RTL8367C_SVLAN_MC2S_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanMC2SConf(uint32 index, rtl8367c_svlan_mc2s_t* pSvlanMc2sCfg)
{
    ret_t retVal;
    uint32 regData;
    uint16 *accessPtr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanSP2CConf(uint32 index, rtl8367c_svlan_s2c_t* pSvlanSp2cCfg)
{
    ret_t retVal;
    uint32 regData;
    uint16 *accessPtr;
    uint32 i;
    uint16 smiSvlanSP2C[RTL8367C_SVLAN_SP2C_LEN];

    if(index > RTL8367C_SP2CMAX)
        return RT_ERR_ENTRY_INDEX;

    memset(smiSvlanSP2C, 0x00, sizeof(uint16) * RTL8367C_SVLAN_SP2C_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanSP2CConf(uint32 index,rtl8367c_svlan_s2c_t* pSvlanSp2cCfg)
{
    ret_t retVal;
    uint32 regData;
    uint16 *accessPtr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanDmacCvidSel(uint32 port, uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanDmacCvidSel(uint32 port, uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUntagVlan(uint32 index)
{
    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUntagVlan(uint32* pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanUnmatchVlan(uint32 index)
{
    if(index > RTL8367C_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanUnmatchVlan(uint32* pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSvlanLookupType(uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicSvlanLookupType(uint32* pType)
{
