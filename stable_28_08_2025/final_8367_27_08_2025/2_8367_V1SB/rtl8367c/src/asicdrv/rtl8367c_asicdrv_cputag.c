 ...
 */
ret_t rtl8367c_setAsicCputagEnable(uint32 enabled)
{
    if(enabled > 1)
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagEnable(uint32 *pEnabled)
{
 ...
 */
ret_t rtl8367c_setAsicCputagTrapPort(uint32 port)
{
    ret_t retVal;
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagTrapPort(uint32 *pPort)
{
    ret_t retVal;
    uint32 tmpPort;
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPortmask(uint32 portmask)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPortmask(uint32 *pPortmask)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagInsertMode(uint32 mode)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagInsertMode(uint32 *pMode)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPriorityRemapping(uint32 srcPri, uint32 newPri)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPriorityRemapping(uint32 srcPri, uint32 *pNewPri)
{
 ...
 *     None
 */
ret_t rtl8367c_setAsicCputagPosition(uint32 postion)
{
 ...
 *     None
 */
ret_t rtl8367c_getAsicCputagPosition(uint32* pPostion)
{
 ...
 *      forwarded to CPU port, and all ports cannot parse CPU tag.
 */
ret_t rtl8367c_setAsicCputagMode(uint32 mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagMode(uint32 *pMode)
{
 ...
 *    	forwarded to CPU port, and all ports cannot parse CPU tag.
 */
ret_t rtl8367c_setAsicCputagRxMinLength(uint32 mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicCputagRxMinLength(uint32 *pMode)
{
