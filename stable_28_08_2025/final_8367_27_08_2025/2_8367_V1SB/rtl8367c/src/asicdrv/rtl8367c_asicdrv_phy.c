 ...
 *      None
 */
ret_t rtl8367c_setAsicPHYOCPReg(uint32 phyNo, uint32 ocpAddr, uint32 ocpData )
{
    ret_t retVal;
    uint32 regAddr;
    ...
    /* OCP prefix */
    ocpAddrPrefix = ((ocpAddr & 0xFC00) >> 10UL);
    if((retVal = rtl8367c_setAsicRegBits(RTL8367C_REG_GPHY_OCP_MSB_0, RTL8367C_CFG_DW8051_OCPADR_MSB_MASK, ocpAddrPrefix)) != RT_ERR_OK)
        return retVal;

    /*prepare access address*/
    ocpAddr9_6 = ((ocpAddr >> 6UL) & 0x000F);
    ocpAddr5_1 = ((ocpAddr >> 1UL) & 0x001F);
    regAddr = RTL8367C_PHY_BASE | (ocpAddr9_6 << 8UL) | (phyNo << RTL8367C_PHY_OFFSET) | ocpAddr5_1;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPHYOCPReg(uint32 phyNo, uint32 ocpAddr, uint32 *pRegData )
{
    ret_t retVal;
    uint32 regAddr;
    uint32 ocpAddrPrefix, ocpAddr9_6, ocpAddr5_1;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPHYReg( uint32 phyNo, uint32 phyAddr, uint32 phyData)
{
    uint32 ocp_addr;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPHYReg( uint32 phyNo, uint32 phyAddr, uint32 *pRegData)
{
    uint32 ocp_addr;
...
ret_t rtl8367c_setAsicSdsReg(uint32 sdsId, uint32 sdsReg, uint32 sdsPage,  uint32 value)
{
    uint32 retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSdsReg(uint32 sdsId, uint32 sdsReg, uint32 sdsPage, uint32 *value)
{
    uint32 retVal, busy;
