 ...
 *
 * $Revision: 66437 $
 * $Date: 2016-03-08 10:51:47 +0800 (???, 08 ?? 2016) $
 *
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaBehavior(uint32 port, uint32 behavior)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaBehavior(uint32 port, uint32 *pBehavior)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownSaBehavior(uint32 behavior)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownSaBehavior(uint32 *pBehavior)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaBehavior(uint32 behavior)
{
    if(behavior >= L2_BEHAVE_SA_END)
        return RT_ERR_NOT_ALLOWED;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaBehavior(uint32 *pBehavior)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnmatchedSaMoving(uint32 port, uint32 enabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnmatchedSaMoving(uint32 port, uint32 *pEnabled)
{
    uint32 data1;
    ret_t retVal;
    ...
    if((retVal = rtl8367c_getAsicRegBit(RTL8367C_REG_L2_SA_MOVING_FORBID, port, &data1)) != RT_ERR_OK)
        return retVal;

    *pEnabled = (data1 == 1) ? 0 : 1;
    return RT_ERR_OK;
}
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownDaFloodingPortmask(uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownDaFloodingPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortUnknownMulticastFloodingPortmask(uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortUnknownMulticastFloodingPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBcastFloodingPortmask(uint32 portmask)
{
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBcastFloodingPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBlockSpa(uint32 port, uint32 permit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBlockSpa(uint32 port, uint32* pPermit)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortDos(uint32 type, uint32 drop)
{
    if(type >= DOS_END)
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortDos(uint32 type, uint32* pDrop)
{
    if(type >= DOS_END)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLink(uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
    uint32 regData = 0;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLink(uint32 port, rtl8367c_port_ability_t *pPortAbility)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortStatus(uint32 port, rtl8367c_port_status_t *pPortStatus)
{
    ret_t retVal;
    uint32 regData;
    ...
    pPortStatus->lpi1000  = (regData >> 11UL) & 0x0001;
    pPortStatus->lpi100   = (regData >> 10UL) & 0x0001;
    pPortStatus->mstfault = (regData >> 9UL) & 0x0001;
    pPortStatus->mstmode  = (regData >> 8UL) & 0x0001;
    pPortStatus->nway     = (regData >> 7UL) & 0x0001;
    pPortStatus->txpause  = (regData >> 6UL) & 0x0001;
    pPortStatus->rxpause  = (regData >> 5UL) & 0x0001;
    pPortStatus->link     = (regData >> 4UL) & 0x0001;
    pPortStatus->duplex   = (regData >> 2UL) & 0x0001;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortForceLinkExt(uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortForceLinkExt(uint32 id, rtl8367c_port_ability_t *pPortAbility)
{
    ...
    if (1 == type)
    {
        ...
        pPortAbility->forcemode = (reg_data >> 12UL) & 0x0001;
        pPortAbility->mstfault  = (reg_data >> 9UL) & 0x0001;
        pPortAbility->mstmode   = (reg_data >> 8UL) & 0x0001;
        pPortAbility->nway      = (reg_data >> 7UL) & 0x0001;
        pPortAbility->txpause   = (reg_data >> 6UL) & 0x0001;
        pPortAbility->rxpause   = (reg_data >> 5UL) & 0x0001;
        pPortAbility->link      = (reg_data >> 4UL) & 0x0001;
        pPortAbility->duplex    = (reg_data >> 2UL) & 0x0001;
    ...
    else if (2 == type)
    {
        if (id == 1)
        {
            ...
            pPortAbility->forcemode = (reg_data >> 12UL) & 1;
            pPortAbility->duplex = (reg_data >> 2UL) & 1;
            pPortAbility->link = (reg_data >> 4UL) & 1;
            pPortAbility->speed = reg_data & 3;
            pPortAbility->rxpause = (reg_data >> 5UL) & 1;
            pPortAbility->txpause = (reg_data >> 6UL) & 1;
        }
        else if (2 == id)
        {
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortExtMode(uint32 id, uint32 mode)
{
    ret_t   retVal;
    uint32 i, regValue, type, option;
    ...
    uint32 redDataSB[][2] = { {0x04D7, 0x0480}, {0xF994, 0x0481}, {0x31A2, 0x0482}, {0x6960, 0x0483}, {0x9728, 0x0484}, {0x9D85, 0x0423}, {0xD810, 0x0424}, {0x83F2, 0x002E} };
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortExtMode(uint32 id, uint32 *pMode)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEnableAll(uint32 enable)
{
    if(enable >= 2)
        return RT_ERR_INPUT;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEnableAll(uint32 *pEnable)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortSmallIpg(uint32 port, uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortSmallIpg(uint32 port, uint32* pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortLoopback(uint32 port, uint32 enable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortLoopback(uint32 port, uint32 *pEnable)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicPortRTCTEnable(uint32 portmask)
{
    ret_t       retVal;
    uint32  regData;
    uint32  port;
 ...
 *      RTCT test takes 4.8 seconds at most.
 */
ret_t rtl8367c_setAsicPortRTCTDisable(uint32 portmask)
{
    ret_t       retVal;
    uint32  regData;
    uint32  port;
 ...
 */
ret_t rtl8367c_getAsicPortRTCTResult(uint32 port, rtl8367c_port_rtct_result_t *pResult)
{
    ret_t       retVal;
    uint32  regData, finish = 1UL;
    ...
    if( (regData == 0x6367) )
    {
        ...
        if((regData & 0x8000) == 0x8000)
        {
            ...
            pResult->channelAOpen       = (regData == 0x0048) ? 1UL : 0UL;
            pResult->channelAShort      = (regData == 0x0050) ? 1UL : 0UL;
            pResult->channelAMismatch   = ((regData == 0x0042) || (regData == 0x0044)) ? 1UL : 0UL;
            pResult->channelALinedriver = (regData == 0x0041) ? 1UL : 0UL;
            ...
            pResult->channelBOpen       = (regData == 0x0048) ? 1UL : 0UL;
            pResult->channelBShort      = (regData == 0x0050) ? 1UL : 0UL;
            pResult->channelBMismatch   = ((regData == 0x0042) || (regData == 0x0044)) ? 1UL : 0UL;
            pResult->channelBLinedriver = (regData == 0x0041) ? 1UL : 0UL;
            ...
            pResult->channelCOpen       = (regData == 0x0048) ? 1UL : 0UL;
            pResult->channelCShort      = (regData == 0x0050) ? 1UL : 0UL;
            pResult->channelCMismatch   = ((regData == 0x0042) || (regData == 0x0044)) ? 1UL : 0UL;
            pResult->channelCLinedriver = (regData == 0x0041) ? 1UL : 0UL;
            ...
            pResult->channelDOpen       = (regData == 0x0048) ? 1UL : 0UL;
            pResult->channelDShort      = (regData == 0x0050) ? 1UL : 0UL;
            pResult->channelDMismatch   = ((regData == 0x0042) || (regData == 0x0044)) ? 1UL : 0UL;
            pResult->channelDLinedriver = (regData == 0x0041) ? 1UL : 0UL;
