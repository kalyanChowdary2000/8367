 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownL2MulticastBehavior(uint32 port, uint32 behave)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownL2MulticastBehavior(uint32 port, uint32 *pBehave)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownIPv4MulticastBehavior(uint32 port, uint32 behave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownIPv4MulticastBehavior(uint32 port, uint32 *pBehave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownIPv6MulticastBehavior(uint32 port, uint32 behave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownIPv6MulticastBehavior(uint32 port, uint32 *pBehave)
{
    if(port >  RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicUnknownMulticastTrapPriority(uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicUnknownMulticastTrapPriority(uint32 *pPriority)
{
