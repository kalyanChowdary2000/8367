 ...
 *      None
 */
ret_t rtl8367c_setAsicLeakyBucketParameter(uint32 tick, uint32 token)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLeakyBucketParameter(uint32 *tick, uint32 *token)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAprMeter(uint32 port, uint32 qid, uint32 apridx)
{
    ret_t retVal;
    uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAprMeter(uint32 port, uint32 qid, uint32 *apridx)
{
    ret_t retVal;
    uint32 regAddr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAprEnable(uint32 port, uint32 aprEnable)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAprEnable(uint32 port, uint32 *aprEnable)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicWFQWeight(uint32 port, uint32 qid, uint32 qWeight)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicWFQWeight(uint32 port, uint32 qid, uint32 *qWeight)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicWFQBurstSize(uint32 burstsize)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicWFQBurstSize(uint32 *burstsize)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicQueueType(uint32 port, uint32 qid, uint32 queueType)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicQueueType(uint32 port, uint32 qid, uint32 *queueType)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEgressRate(uint32 port, uint32 rate)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEgressRate(uint32 port, uint32 *rate)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortEgressRateIfg(uint32 ifg)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortEgressRateIfg(uint32 *ifg)
{
    ret_t retVal;
