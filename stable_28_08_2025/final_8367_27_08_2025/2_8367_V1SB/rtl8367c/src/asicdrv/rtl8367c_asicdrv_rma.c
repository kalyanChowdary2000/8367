 ...
 *
 * $Revision: 64716 $
 * $Date: 2015-12-31 16:31:55 +0800 (?üÊ??? 31 ?Å‰???2015) $
 *
 ...
 *      None
 */
ret_t rtl8367c_setAsicRma(uint32 index, rtl8367c_rma_t* pRmacfg)
{
    uint32 regData = 0;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRma(uint32 index, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRmaLldp(uint32 enabled, rtl8367c_rma_t* pRmacfg)
{
    uint32 regData = 0;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRmaLldp(uint32 *pEnabled, rtl8367c_rma_t* pRmacfg)
{
    ret_t retVal;
    uint32 regData;
