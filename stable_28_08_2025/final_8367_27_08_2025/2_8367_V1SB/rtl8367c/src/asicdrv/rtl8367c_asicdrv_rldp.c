 ...
 *
 * $Revision: 42321 $
 * $Date: 2013-08-26 13:51:29 +0800 (?±ä?, 26 ?«æ? 2013) $
 *
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldp(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldp(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpEnable8051(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpEnable8051(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpCompareRandomNumber(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpCompareRandomNumber(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpIndicatorSource(uint32 src)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpIndicatorSource(uint32 *pSrc)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpCheckingStatePara(uint32 retryCount, uint32 retryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpCheckingStatePara(uint32 *pRetryCount, uint32 *pRetryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpLoopStatePara(uint32 retryCount, uint32 retryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopStatePara(uint32 *pRetryCount, uint32 *pRetryPeriod)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpTxPortmask(uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpTxPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopedPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLoopedPortPair(uint32 port, uint32 *pLoopedPair)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRlppTrap8051(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRlppTrap8051(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpLeaveLoopedPortmask(uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpLeaveLoopedPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpEnterLoopedPortmask(uint32 portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpEnterLoopedPortmask(uint32 *pPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldpTriggerMode(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldpTriggerMode(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRldp8051Portmask(uint32 portmask)
{
    ret_t retVal;
    if(portmask > RTL8367C_PORTMASK)
        return RT_ERR_PORT_MASK;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRldp8051Portmask(uint32 *pPortmask)
{
    uint32 tmpPmsk;
    ret_t retVal;
