 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsCounterReset(uint32 greset, uint32 qmreset, uint32 portmask)
{
    ret_t retVal;
    uint32 regData;
    uint32 regBits;
 ...
 */
ret_t rtl8367c_getAsicMIBsCounter(uint32 port, RTL8367C_MIBCOUNTER mibIdx, uint32* pcounterH, uint32* pcounterL)
{
    ret_t retVal;
    uint32 regAddr;
    uint32 regData;
    ...
    CONST uint16 mibLength[RTL8367C_MIBS_NUMBER]= {
    ...
    while(i)
    {
		...
		if ( i == 2 )
        {
            *pcounterH = mibCounter;
            mibCounter = 0;
        }

        if ( i == 0 )
        {
            *pcounterL = mibCounter;
        }
 ...
 */
ret_t rtl8367c_getAsicMIBsLogCounter(uint32 index, uint32 *pCounter)
{
    ret_t retVal;
    uint32 regAddr;
    uint32 regData;
 ...
 */
ret_t rtl8367c_getAsicMIBsControl(uint32* pMask)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetValue(uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsResetValue(uint32* value)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsUsageMode(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsUsageMode(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsTimer(uint32 timer)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsTimer(uint32* pTimer)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingMode(uint32 index, uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingMode(uint32 index, uint32* pMode)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLoggingType(uint32 index, uint32 type)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLoggingType(uint32 index, uint32* pType)
{
    if(index > RTL8367C_MIB_MAX_LOG_MODE_IDX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsResetLoggingCounter(uint32 index)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicMIBsLength(uint32 txLengthMode, uint32 rxLengthMode)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMIBsLength(uint32 *pTxLengthMode, uint32 *pRxLengthMode)
{
    ret_t retVal;
