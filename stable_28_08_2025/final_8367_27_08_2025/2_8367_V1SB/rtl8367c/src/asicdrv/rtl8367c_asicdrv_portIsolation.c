 ...
 *      None
 */
ret_t rtl8367c_setAsicPortIsolationPermittedPortmask(uint32 port, uint32 permitPortmask)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIsolationPermittedPortmask(uint32 port, uint32 *pPermitPortmask)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicPortIsolationEfid(uint32 port, uint32 efid)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortIsolationEfid(uint32 port, uint32 *pEfid)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
