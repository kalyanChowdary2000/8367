 ...
 *      None
 */
ret_t rtl8367c_getAsicIgmp(uint32 *ptr_enabled)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIpMulticastVlanLeaky(uint32 port, uint32 *ptr_enabled)
{
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPdynamicRouterPort1(uint32 *port, uint32 *timer)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPdynamicRouterPort2(uint32 *port, uint32 *timer)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPSuppression(uint32 *report_supp_enabled, uint32 *leave_supp_enabled)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPQueryRX(uint32 port, uint32 *allow_query)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPReportRX(uint32 port, uint32 *allow_report)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPLeaveRX(uint32 port, uint32 *allow_leave)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPMRPRX(uint32 port, uint32 *allow_mrp)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPMcDataRX(uint32 port, uint32 *allow_mcdata)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPv1Opeartion(uint32 port, uint32 *igmpv1_op)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPv2Opeartion(uint32 port, uint32 *igmpv2_op)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPv3Opeartion(uint32 port, uint32 *igmpv3_op)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMLDv1Opeartion(uint32 port, uint32 *mldv1_op)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicMLDv2Opeartion(uint32 port, uint32 *mldv2_op)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPPortMAXGroup(uint32 port, uint32 *max_group)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPPortCurrentGroup(uint32 port, uint32 *current_group)
{
    ret_t   retVal;
    uint32  value;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIGMPGroup(uint32 idx, uint32 *valid, rtl8367c_igmpgroup *grp)
{
    ret_t   retVal;
    ...
    for(i = 0 ;i <= 1; i++)
    {
        ...
        groupInfo |= ((regData & 0xFFFF) << (i * 16UL));
        regAddr ++;
    }

    grp->p0_timer = groupInfo & 0x00000007;
    grp->p1_timer = (groupInfo >> 3UL) & 0x00000007;
    grp->p2_timer = (groupInfo >> 6UL) & 0x00000007;
    grp->p3_timer = (groupInfo >> 9UL) & 0x00000007;
    grp->p4_timer = (groupInfo >> 12UL) & 0x00000007;
    grp->p5_timer = (groupInfo >> 15UL) & 0x00000007;
    grp->p6_timer = (groupInfo >> 18UL) & 0x00000007;
    grp->p7_timer = (groupInfo >> 21UL) & 0x00000007;
    grp->report_supp_flag = (groupInfo >> 24UL) & 0x00000001;
    grp->p8_timer = (groupInfo >> 25UL) & 0x00000007;
    grp->p9_timer = (groupInfo >> 28UL) & 0x00000007;
    grp->p10_timer = (groupInfo >> 31UL) & 0x00000001;
    ...
    grp->p10_timer |= (regData & 0x00000003) << 1UL;
    ...
    *valid = ((regData & (1UL << (idx %16))) != 0UL) ? 1UL : 0UL;
 ...
 *      None
 */
ret_t rtl8367c_getAsicIpMulticastPortIsoLeaky(uint32 port, uint32 *enabled)
{
    ret_t   retVal;
    uint32  regData;
