 ...
 *
 * $Revision: 76306 $
 * $Date: 2017-03-08 15:13:58 +0800 (?熸?涓? 08 涓夋? 2017) $
 *
...
static void _rtl8367c_fdbStUser2Smi( rtl8367c_luttb *pLutSt, uint16 *pFdbSmi)
{
    /* L3 lookup */
    if(pLutSt->l3lookup)
    {
...
static void _rtl8367c_fdbStSmi2User( rtl8367c_luttb *pLutSt, uint16 *pFdbSmi)
{
    /*L3 lookup*/
    if(pFdbSmi[3] & 0x1000)
    {
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastLookup(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastLookup(uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpMulticastVidLookup(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpMulticastVidLookup(uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpLookupMethod(uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpLookupMethod(uint32* pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutAgeTimerSpeed(uint32 timer, uint32 speed)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutAgeTimerSpeed(uint32* pTimer, uint32* pSpeed)
{
    uint32 regData;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutCamTbUsage(uint32 enabled)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutCamTbUsage(uint32* pEnabled)
{
    ret_t       retVal;
    uint32  regData;
...
ret_t rtl8367c_setAsicLutLearnLimitNo(uint32 port, uint32 number)
{
...
ret_t rtl8367c_getAsicLutLearnLimitNo(uint32 port, uint32* pNumber)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
...
ret_t rtl8367c_setAsicSystemLutLearnLimitNo(uint32 number)
{
    if(number > RTL8367C_LUT_LEARNLIMITMAX)
        return RT_ERR_LIMITED_L2ENTRY_NUM;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnLimitNo(uint32 *pNumber)
{
    if(NULL == pNumber)
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLearnOverAct(uint32 action)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLearnOverAct(uint32* pAction)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicSystemLutLearnOverAct(uint32 action)
{
    if(action >= LRNOVERACT_END)
        return RT_ERR_NOT_ALLOWED;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSystemLutLearnOverAct(uint32 *pAction)
{
    if(NULL == pAction)
        return RT_ERR_NULL_POINTER;
...
ret_t rtl8367c_setAsicSystemLutLearnPortMask(uint32 portmask)
{
    ret_t retVal;
 ...
 */
 /*修改: RTL8367C_LUT_SYSTEM_LEARN_PMASK_MASK*/
ret_t rtl8367c_getAsicSystemLutLearnPortMask(uint32 *pPortmask)
{
    uint32 tmpmask;
    ret_t retVal;
...
ret_t rtl8367c_setAsicL2LookupTb(rtl8367c_luttb *pL2Table)
{
    ...
    uint16 *accessPtr;
    uint32 i;
    uint16 smil2Table[RTL8367C_LUT_TABLE_SIZE];
    uint32 tblCmd;
    uint32 busyCounter;

    memset(smil2Table, 0x00, sizeof(uint16) * RTL8367C_LUT_TABLE_SIZE);
 ...
 *      None
 */
ret_t rtl8367c_getAsicL2LookupTb(uint32 method, rtl8367c_luttb *pL2Table)
{
    ret_t retVal;
    uint32 regData;
    uint16* accessPtr;
...
ret_t rtl8367c_getAsicLutLearnNo(uint32 port, uint32* pNumber)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushAllStatus(uint32 *pBusyStatus)
{
    if(NULL == pBusyStatus)
        return RT_ERR_NULL_POINTER;
...
ret_t rtl8367c_setAsicLutForceFlush(uint32 portmask)
{
    ret_t retVal;
 ...
 */
 /*port8~port10的设置在另外一个register, wait for updating of base.h, reg.h*/
ret_t rtl8367c_getAsicLutForceFlushStatus(uint32 *pPortmask)
{
    uint32 tmpMask;
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushMode(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushMode(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushType(uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushType(uint32* pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushVid(uint32 vid)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushVid(uint32* pVid)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutFlushFid(uint32 fid)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutFlushFid(uint32* pFid)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutDisableAging(uint32 port, uint32 disabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutDisableAging(uint32 port, uint32 *pDisabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIPMCGroup(uint32 index, ipaddr_t group_addr, uint32 vid, uint32 pmask, uint32 valid)
{
    uint32  regAddr, regData, bitoffset;
    ipaddr_t    ipData;
    ret_t       retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIPMCGroup(uint32 index, ipaddr_t *pGroup_addr, uint32 *pVid, uint32 *pPmask, uint32 *pValid)
{
    uint32      regAddr, regData, bitoffset;
    ipaddr_t    ipData;
    ret_t       retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutLinkDownForceAging(uint32 enable)
{
    if(enable > 1)
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutLinkDownForceAging(uint32 *pEnable)
{
    uint32  value;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicLutIpmcFwdRouterPort(uint32 enable)
{
    if(enable > 1)
        return RT_ERR_ENABLE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicLutIpmcFwdRouterPort(uint32 *pEnable)
{
    if(NULL == pEnable)
        return RT_ERR_NULL_POINTER;
