 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingMode(uint32 mode)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingMode(uint32* pMode)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingFc(uint32 group, uint32 enabled)
{
    ret_t       retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingFc(uint32 group, uint32* pEnabled)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingGroup(uint32 group, uint32 portmask)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingGroup(uint32 group, uint32* pPortmask)
{
    if(group > RTL8367C_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingFlood(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingFlood(uint32* pEnabled)
{
 ...
 */
ret_t rtl8367c_setAsicTrunkingHashSelect(uint32 hashsel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashSelect(uint32* pHashsel)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicQeueuEmptyStatus(uint32* portmask)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingHashTable(uint32 hashval, uint32 portId)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashTable(uint32 hashval, uint32* pPortId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicTrunkingHashTable1(uint32 hashval, uint32 portId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicTrunkingHashTable1(uint32 hashval, uint32* pPortId)
{
    if(hashval > RTL8367C_TRUNKING_HASHVALUE_MAX)
        return RT_ERR_OUT_OF_RANGE;
