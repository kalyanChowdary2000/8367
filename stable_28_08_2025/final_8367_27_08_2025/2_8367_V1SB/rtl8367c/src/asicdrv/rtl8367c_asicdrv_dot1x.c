 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBEnConfig(uint32 port, uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBEnConfig(uint32 port, uint32 *pEnabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBAuthConfig(uint32 port, uint32 auth)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBAuthConfig(uint32 port, uint32 *pAuth)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xPBOpdirConfig(uint32 port, uint32 opdir)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xPBOpdirConfig(uint32 port, uint32* pOpdir)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xMBEnConfig(uint32 port, uint32 enabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xMBEnConfig(uint32 port, uint32 *pEnabled)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xMBOpdirConfig(uint32 opdir)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xMBOpdirConfig(uint32 *pOpdir)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xProcConfig(uint32 port, uint32 proc)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xProcConfig(uint32 port, uint32* pProc)
{
    if(port >= RTL8367C_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xGuestVidx(uint32 index)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xGuestVidx(uint32 *pIndex)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xGVOpdir(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xGVOpdir(uint32 *pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsic1xTrapPriority(uint32 priority)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsic1xTrapPriority(uint32 *pPriority)
{
