 ...
 *
 * $Revision: 64755 $
 * $Date: 2016-01-04 17:17:13 +0800 (?Ÿæ?ä¸€, 04 ä¸€??2016) $
 *
...
static void _rtl8367c_VlanMCStUser2Smi(rtl8367c_vlanconfiguser *pVlanCg, uint16 *pSmiVlanCfg)
{
...
static void _rtl8367c_VlanMCStSmi2User(uint16 *pSmiVlanCfg, rtl8367c_vlanconfiguser *pVlanCg)
{
...
static void _rtl8367c_Vlan4kStUser2Smi(rtl8367c_user_vlan4kentry *pUserVlan4kEntry, uint16 *pSmiVlan4kEntry)
{
...
static void _rtl8367c_Vlan4kStSmi2User(uint16 *pSmiVlan4kEntry, rtl8367c_user_vlan4kentry *pUserVlan4kEntry)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanMemberConfig(uint32 index, rtl8367c_vlanconfiguser *pVlanCg)
{
    ret_t  retVal;
    uint32 regAddr;
    uint32 regData;
    uint16 *tableAddr;
    uint32 page_idx;
    uint16 smi_vlancfg[RTL8367C_VLAN_MBRCFG_LEN];
    ...
    memset(smi_vlancfg, 0x00, sizeof(uint16) * RTL8367C_VLAN_MBRCFG_LEN);
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanMemberConfig(uint32 index, rtl8367c_vlanconfiguser *pVlanCg)
{
    ret_t  retVal;
    uint32 page_idx;
    uint32 regAddr;
...
{
    uint16              vlan_4k_entry[RTL8367C_VLAN_4KTABLE_LEN];
    uint32                  page_idx;
    uint16                  *tableAddr;
    ret_t                   retVal;
    uint32                  regData;
    ...
    memset(vlan_4k_entry, 0x00, sizeof(uint16) * RTL8367C_VLAN_4KTABLE_LEN);
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanAccpetFrameType(uint32 port, rtl8367c_accframetype frameType)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanAccpetFrameType(uint32 port, rtl8367c_accframetype *pFrameType)
{
    uint32 regData;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanIngressFilter(uint32 port, uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanIngressFilter(uint32 port, uint32 *pEnable)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanEgressTagMode(uint32 port, rtl8367c_egtagmode tagMode)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanEgressTagMode(uint32 port, rtl8367c_egtagmode *pTagMode)
{
    uint32 regData;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanPortBasedVID(uint32 port, uint32 index, uint32 pri)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanPortBasedVID(uint32 port, uint32 *pIndex, uint32 *pPri)
{
    uint32 regAddr,bit_mask;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanProtocolBasedGroupData(uint32 index, rtl8367c_protocolgdatacfg *pPbCfg)
{
    uint32  frameType;
    uint32  etherType;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanProtocolBasedGroupData(uint32 index, rtl8367c_protocolgdatacfg *pPbCfg)
{
    uint32  frameType;
    uint32  etherType;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanPortAndProtocolBased(uint32 port, uint32 index, rtl8367c_protocolvlancfg *pPpbCfg)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanPortAndProtocolBased(uint32 port, uint32 index, rtl8367c_protocolvlancfg *pPpbCfg)
{
    uint32  reg_addr, bit_mask, bit_value;
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanFilter(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanFilter(uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanUntagDscpPriorityEn(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanUntagDscpPriorityEn(uint32* enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBasedFid(uint32 port, uint32 fid)
{
    uint32  reg_addr;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBasedFid(uint32 port, uint32* pFid)
{
    uint32  reg_addr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortBasedFidEn(uint32 port, uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortBasedFidEn(uint32 port, uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicSpanningTreeStatus(uint32 port, uint32 msti, uint32 state)
{
	uint32  reg_addr,bits_msk;
 ...
 *      None
 */
ret_t rtl8367c_getAsicSpanningTreeStatus(uint32 port, uint32 msti, uint32* pState)
{
    uint32  reg_addr,bits_msk;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanTransparent(uint32 port, uint32 portmask)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanTransparent(uint32 port, uint32 *pPortmask)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicVlanEgressKeep(uint32 port, uint32 portmask)
{
    uint32 regAddr, bit_mask;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicVlanEgressKeep(uint32 port, uint32* pPortmask)
{
    uint32 regAddr, bit_mask, regval_l, regval_h;
    ret_t  retVal;
 ...
 *      None
 */
ret_t rtl8367c_setReservedVidAction(uint32 vid0Action, uint32 vid4095Action)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getReservedVidAction(uint32 *pVid0Action, uint32 *pVid4095Action)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_setRealKeepRemarkEn(uint32 enabled)
{
    ret_t   retVal;
 ...
 *      None
 */
ret_t rtl8367c_getRealKeepRemarkEn(uint32 *pEnabled)
{
    ret_t   retVal;
