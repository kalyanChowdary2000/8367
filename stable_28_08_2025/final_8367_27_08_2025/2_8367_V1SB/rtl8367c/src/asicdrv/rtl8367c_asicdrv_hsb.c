 ...
 */
ret_t rtl8367c_setAsicFieldSelector(uint32 index, uint32 format, uint32 offset)
{
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicFieldSelector(uint32 index, uint32* pFormat, uint32* pOffset)
{
    ret_t retVal;
    uint32 regData;
