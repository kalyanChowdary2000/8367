 ...
 *
 * $Revision: 38651 $
 * $Date: 2016-02-27 14:32:56 +0800 (?¨ä?, 17 ?›æ? 2016) $
 *
 ...
 */
ret_t rtl8367c_setAsicI2CTxOneCharCmd(uint8 oneChar)
{
    uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CRxOneCharCmd(uint8 *pValue)
{
    uint32 regData;
    ret_t retVal;
 ...
 */
ret_t rtl8367c_setAsicI2CGpioPinGroup(uint32 pinGroup_ID)
{
    uint32 regData;
    ret_t retVal;
 ...
 *      There are three group gpio pins
 */
ret_t rtl8367c_getAsicI2CGpioPinGroup(uint32 * pPinGroup_ID)
{
