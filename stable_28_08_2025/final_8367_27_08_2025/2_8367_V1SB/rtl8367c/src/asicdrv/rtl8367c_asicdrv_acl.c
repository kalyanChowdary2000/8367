...
uint16 Rtl8370sVirtualAclActTable[RTL8367C_ACLRULENO][RTL8367C_ACL_ACT_TABLE_LEN];
#endif
...
{
    uint8 *care_ptr, *data_ptr;
    uint8 care_tmp, data_tmp;
    uint32 i;
    ...
    care_ptr = (uint8*)&pAclSmi->care_bits;
    data_ptr = (uint8*)&pAclSmi->data_bits;
    ...
    care_ptr = (uint8*)&pAclSmi->care_bits_ext;
    data_ptr = (uint8*)&pAclSmi->data_bits_ext;
...
/*
    Exchange structure type define with MMI and SMI
*/
static void _rtl8367c_aclActStSmi2User(rtl8367c_acl_act_t *pAclUser, uint16 *pAclSmi)
{
...
/*
    Exchange structure type define with MMI and SMI
*/
static void _rtl8367c_aclActStUser2Smi(rtl8367c_acl_act_t *pAclUser, uint16 *pAclSmi)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicAcl(uint32 port, uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicAcl(uint32 port, uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclUnmatchedPermit(uint32 port, uint32 enabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclUnmatchedPermit(uint32 port, uint32* pEnabled)
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 */
ret_t rtl8367c_setAsicAclRule(uint32 index, rtl8367c_aclrule* pAclRule)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclRule(uint32 index, rtl8367c_aclrule *pAclRule)
{
    rtl8367c_aclrulesmi aclRuleSmi;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclNot(uint32 index, uint32 not)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclNot(uint32 index, uint32* pNot)
{
    if(index > RTL8367C_ACLRULEMAX)
        return RT_ERR_OUT_OF_RANGE;
 ...
 */
ret_t rtl8367c_setAsicAclTemplate(uint32 index, rtl8367c_acltemplate_t* pAclType)
{	
    ret_t retVal;
    uint32 i;
    uint32 regAddr, regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclTemplate(uint32 index, rtl8367c_acltemplate_t *pAclType)
{
    ret_t retVal;
    uint32 i;
    uint32 regData, regAddr;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclAct(uint32 index, rtl8367c_acl_act_t* pAclAct)
{
    uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    uint32 regAddr, regData;
    uint16* tableAddr;
    uint32 i;
    ...
    memset(aclActSmi, 0x00, sizeof(uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    memcpy(&Rtl8370sVirtualAclActTable[index][0], aclActSmi, sizeof(uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclAct(uint32 index, rtl8367c_acl_act_t *pAclAct)
{
    uint16 aclActSmi[RTL8367C_ACL_ACT_TABLE_LEN];
    ret_t retVal;
    uint32 regAddr, regData;
...
#ifdef CONFIG_RTL8367C_ASICDRV_TEST
    memcpy(aclActSmi, &Rtl8370sVirtualAclActTable[index][0], sizeof(uint16) * RTL8367C_ACL_ACT_TABLE_LEN);
#endif
 ...
 */
ret_t rtl8367c_setAsicAclActCtrl(uint32 index, uint32 aclActCtrl)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclActCtrl(uint32 index, uint32 *pAclActCtrl)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclPortRange(uint32 index, uint32 type, uint32 upperPort, uint32 lowerPort)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclPortRange(uint32 index, uint32* pType, uint32* pUpperPort, uint32* pLowerPort)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclVidRange(uint32 index, uint32 type, uint32 upperVid, uint32 lowerVid)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclVidRange(uint32 index, uint32* pType, uint32* pUpperVid, uint32* pLowerVid)
{
    ret_t retVal;
    uint32 regData;
 ...
 *      None
 */
ret_t rtl8367c_setAsicAclIpRange(uint32 index, uint32 type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    ret_t retVal;
    uint32 regData;
    ipaddr_t ipData;
 ...
 *      None
 */
ret_t rtl8367c_getAsicAclIpRange(uint32 index, uint32* pType, ipaddr_t* pUpperIp, ipaddr_t* pLowerIp)
{
    ret_t retVal;
    uint32 regData;
    ipaddr_t ipData;
 ...
 *      none
 */
ret_t rtl8367c_setAsicAclGpioPolarity(uint32 polarity)
{
 ...
 *      none
 */
ret_t rtl8367c_getAsicAclGpioPolarity(uint32* pPolarity)
{
