 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDot1qRemapping(uint32 srcpriority, uint32 priority )
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDot1qRemapping(uint32 srcpriority, uint32 *pPriority )
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityPortBased(uint32 port, uint32 priority )
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityPortBased(uint32 port, uint32 *pPriority )
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDscpBased(uint32 dscp, uint32 priority )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDscpBased(uint32 dscp, uint32 *pPriority )
{
    if(dscp > RTL8367C_DSCPMAX)
        return RT_ERR_QOS_DSCP_VALUE;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityDecision(uint32 index, uint32 prisrc, uint32 decisionPri)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityDecision(uint32 index, uint32 prisrc, uint32* pDecisionPri)
{
    ret_t retVal;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPortPriorityDecisionIndex(uint32 port, uint32 index )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPortPriorityDecisionIndex(uint32 port, uint32 *pIndex )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicOutputQueueMappingIndex(uint32 port, uint32 index )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_getAsicOutputQueueMappingIndex(uint32 port, uint32 *pIndex )
{
    if(port > RTL8367C_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
ret_t rtl8367c_setAsicPriorityToQIDMappingTable(uint32 index, uint32 priority, uint32 qid )
{
    if(index >= RTL8367C_QUEUENO)
        return RT_ERR_QUEUE_NUM;
 ...
 *      None
 */
ret_t rtl8367c_getAsicPriorityToQIDMappingTable(uint32 index, uint32 priority, uint32* pQid)
{
    if(index >= RTL8367C_QUEUENO)
        return RT_ERR_QUEUE_NUM;
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDot1pAbility(uint32 port, uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pAbility(uint32 port, uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDot1pParameter(uint32 priority, uint32 newPriority )
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pParameter(uint32 priority, uint32 *pNewPriority )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 */
ret_t rtl8367c_setAsicRemarkingDot1pSrc(uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDot1pSrc(uint32 *pType)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDscpAbility(uint32 enabled)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpAbility(uint32* pEnabled)
{
 ...
 *      None
 */
ret_t rtl8367c_setAsicRemarkingDscpParameter(uint32 priority, uint32 newDscp )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpParameter(uint32 priority, uint32* pNewDscp )
{
    if(priority > RTL8367C_PRIMAX )
        return RT_ERR_QOS_INT_PRIORITY;
 ...
 *      priority to TX DSCP value.
 */
ret_t rtl8367c_setAsicRemarkingDscpSrc(uint32 type)
{
 ...
 *      None
 */
ret_t rtl8367c_getAsicRemarkingDscpSrc(uint32 *pType)
{
 ...
 */
ret_t rtl8367c_setAsicRemarkingDscp2Dscp(uint32 dscp, uint32 rmkDscp)
{
 ...
 *      None.
 */
ret_t rtl8367c_getAsicRemarkingDscp2Dscp(uint32 dscp, uint32 *pRmkDscp)
{
    if(dscp > RTL8367C_DSCPMAX)
        return RT_ERR_QOS_DSCP_VALUE;
