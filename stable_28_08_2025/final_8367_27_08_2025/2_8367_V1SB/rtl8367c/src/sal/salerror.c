...
const char *
_rtk_api_error_msg(int32 errCode)
{
    char buf[20];
    ...
    switch (errCode)
    {
        ...
        default:                            
            ...
            sprintf(buf, "Unknown error: %ld", errCode);
            return buf;
    }
}

const char *
sal_err_msg_get(int32 errCode)
{
    switch (errCode)
    {
    case SAL_ERR_FAILED:                    return "Failed";
    case SAL_ERR_SUCCESS:                   return "Success";

    /* common error message */
    case SAL_ERR_ENTRY_INDEX:               return "Invalid entry index";
    case SAL_ERR_PORT_RANGE:                return "Invalid port number";
    case SAL_ERR_PORT_MASK:                 return "Invalid port mask";
    case SAL_ERR_NULL_POINTER:              return "NULL pointer";
    case SAL_ERR_INVALID_RATE:              return "Invalid rate";
    case SAL_ERR_PARAMETER:                 return "Invalid parameter";
    case SAL_ERR_NOT_SUPPORT:               return "Action not supported";

    /* MAC Table */    
    case SAL_ERR_MAC_ENTRY_INVALID:         return "Invalid MAC entry";
    case SAL_ERR_MAC_ENTRY_NOT_FOUND:       return "MAC entry not found";
    case SAL_ERR_MAC_ENTRY_ADD_FAILED:      return "MAC entry add failed";
    case SAL_ERR_MAC_ENTRY_DEL_FAILED:      return "MAC entry delete failed";
    case SAL_ERR_FLTR_ENTRY_ADD_FAILED:     return "Filter entry add failed";
    case SAL_ERR_FLTR_ENTRY_DEL_FAILED:     return "Filter entry delete failed";
    case SAL_ERR_NOT_FLTR_ENTRY:            return "Not a filter entry";
    case SAL_ERR_FLTR_ENTRY_NOT_FOUND:      return "Filter entry not found";

    /* Port Mirroring */
    case SAL_ERR_MIRROR_GET_FAILED:         return "Failed to get port mirror";
    case SAL_ERR_MIRROR_SET_FAILED:         return "Failed to set port mirror";
    case SAL_ERR_MIRROR_DIRECTION:          return "Mirror direction not supported";
    case SAL_ERR_MIRROR_SAME_EGRESS:        return "Two egress mirror set with the same mirroring port";
    case SAL_ERR_MIRROR_OVERLAP_SET:        return "Two mirror set with the same mirroring port "
                                                "should put ingress mirroring in set 0 & "
                                                "egress mirroring in set 1";

    /* Storm Control */
    case SAL_ERR_STRM_CTRL_INVALID_RATE:    return "Storm control invalid rate";
    case SAL_ERR_STRM_CTRL_UNKNOWN_FILTER:  return "Unknown storm control filter";

    /* Trunk */
    case SAL_ERR_TRUNK_PORT_USED_BY_TRK:    return "Port already used by another trunk";
    case SAL_ERR_TRUNK_PORT_VLAN_CONFLICT:  return "Joined VLAN of trunk member ports should be the same";
    case SAL_ERR_TRUNK_PORT_IN_MIRROR:      return "Mirroring port cannot be a trunk member port";
    case SAL_ERR_TRUNK_PORT_RATE_LIMITED:   return "Port with ingress/egress rate limiting cannot be a trunk member port";
    case SAL_ERR_TRUNK_PORT_NEGO:           return "Trunk member ports must all have the same negotiation mode";
    case SAL_ERR_TRUNK_PORT_SPEED:          return "Trunk member ports must all have the same speed";
    case SAL_ERR_TRUNK_PORT_DUPLEX:         return "Trunk member ports must all be full duplex";
    case SAL_ERR_TRUNK_TRK_NO_EXIST:        return "Trunk does not exist";
    case SAL_ERR_TRUNK_TRK_RANGE:           return "Wrong trunk ID";
    case SAL_ERR_TRUNK_NOT_MEMBER_PORT:     return "The port is not a member port of the trunk";
    case SAL_ERR_TRUNK_LESS_THAN_2_PORTS:   return "2 trunk member ports at least";
    case SAL_ERR_TRUNK_MORE_THAN_4_PORTS:   return "4 trunk member ports at most";
    case SAL_ERR_TRUNK_PORT_IN_TRUNK:       return "This is link aggregation member port";
    case SAL_ERR_TRUNK_PORT_NUM_TOO_LOW:    return "At least two ports should be added";    
    case SAL_ERR_TRUNK_PORT_NUM_TOO_HIGH:   return "The number of selected ports exceeds limit";
    
    /*VLAN*/
    case SAL_ERR_INPUT_STR_LEN:             return "Input string length error";
    case SAL_ERR_DUPLICATE_NAME:            return "The name is already existed";
    case SAL_ERR_VLAN_DISABLE:              return "VLAN is disabled";
    case SAL_ERR_VLAN_ID_INVALID:           return "Invalid VLAN ID";
    case SAL_ERR_VLAN_ENTRY_INDEX:          return "VLAN table index error";
    case SAL_ERR_VLAN_FULL:                 return "VLAN table is full";
    case SAL_ERR_VLAN_EXIST_PVID:           return "Port-based VLAN ID is existed";
    case SAL_ERR_VLAN_EXIST:                return "VLAN is existed";
    case SAL_ERR_VLAN_NOT_EXIST:            return "VLAN is not existed";
    case SAL_ERR_VLAN_INS_VLAN_ENTRY:       return "Insert VLAN entry error";
    case SAL_ERR_VLAN_DEL_VLAN_ENTRY:       return "Delete VLAN entry error";
    case SAL_ERR_VLAN_DEL_DEFAULT_VLAN:     return "Default VLAN can not be deleted";
    case SAL_ERR_VLAN_ENTRY_INVALID:        return "Invalid VLAN entry, check whether it is an empty entry";
    case SAL_ERR_VLAN_ENTRY_DUPLICATE:      return "There exists another entry with the same vid";
        
    /*SVLAN*/
    case SAL_ERR_SVLAN_ENTRY_INDEX:         return "Invalid svid entry NO.";                                       
    case SAL_ERR_SVLAN_ETHER_TYPE:          return "Invalid SVLAN ether type";                                        
    case SAL_ERR_SVLAN_TABLE_FULL:          return "No empty entry in SVLAN table";                                    
    case SAL_ERR_SVLAN_ENTRY_NOT_FOUND:     return "Specified svlan entry not found";                                 
    case SAL_ERR_SVLAN_EXIST:               return "SVLAN entry is exist";
    case SAL_ERR_SVLAN_VID:                 return "Invalid S-VLAN ID";
    case SAL_ERR_SVLAN_ENTRY_INVALID:       return "Invalid S-VLAN entry, check whether it is an empty entry"; 
    case SAL_ERR_SVLAN_ENTRY_DUPLICATE:     return "There exists another entry with the same svid";
    case SAL_ERR_SVLAN_ENTRY_NULL:          return "The operation will cause svlan entry to be null";
    
    /* Jumbo frame */
    case SAL_ERR_JUMBO_FRAME_SIZE:          return "Jumbo frame size not supported";
    case SAL_ERR_JUMBO_FRAME_GET:           return "Failed to get jumbo frame size";

    /* Port Isolation */
    case SAL_ERR_PORT_ISOLATION_SET:        return "Failed to set port isolation";
    case SAL_ERR_PORT_ISOLATION_GET:        return "Failed to get port isolation";

    case SAL_ERR_UNKNOWN:
    default:                                return _rtk_api_error_msg(errCode);
    }
}

#if 0
void
SalErrPrintMsg(int32 errCode)
{
    printf("Error #%d: %s\n", errCode, SalErrGetMsg(errCode));
}
#endif
