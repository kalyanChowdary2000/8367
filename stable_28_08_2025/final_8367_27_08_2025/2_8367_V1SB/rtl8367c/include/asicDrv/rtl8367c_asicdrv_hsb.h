...
extern ret_t rtl8367c_setAsicFieldSelector(uint32 index, uint32 format, uint32 offset);
extern ret_t rtl8367c_getAsicFieldSelector(uint32 index, uint32* pFormat, uint32* pOffset);
