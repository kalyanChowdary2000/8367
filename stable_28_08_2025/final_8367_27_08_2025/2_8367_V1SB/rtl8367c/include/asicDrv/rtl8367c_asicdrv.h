...
extern "C" {
#endif
extern ret_t rtl8367c_setAsicRegBit(uint32 reg, uint32 bitIdx, uint32 value) large;
extern ret_t rtl8367c_getAsicRegBit(uint32 reg, uint32 bitIdx, uint32 *pValue) large;

extern ret_t rtl8367c_setAsicRegBits(uint32 reg, uint32 bits, uint32 value) large;
extern ret_t rtl8367c_getAsicRegBits(uint32 reg, uint32 bits, uint32 *pValue) large;

extern ret_t rtl8367c_setAsicReg(uint32 reg, uint32 value) large;
extern ret_t rtl8367c_getAsicReg(uint32 reg, uint32 *pValue) large;
