...
extern ret_t rtl8367c_setAsicI2CTxOneCharCmd(uint8 oneChar);
extern ret_t rtl8367c_setAsicI2CcheckRxAck(void);
extern ret_t rtl8367c_setAsicI2CRxOneCharCmd(uint8 *pValue);
...
extern ret_t rtl8367c_setAsicI2CGpioPinGroup(uint32 pinGroup_ID);
extern ret_t rtl8367c_getAsicI2CGpioPinGroup(uint32 * pPinGroup_ID);
