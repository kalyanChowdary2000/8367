 ...
 */
extern rtk_api_ret_t rtk_l2_addr_next_get(rtk_l2_read_method_t read_method, rtk_port_t port, uint32 *pAddress, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern rtk_api_ret_t rtk_l2_mcastAddr_next_get(uint32 *pAddress, rtk_l2_mcastAddr_t *pMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastAddr_next_get(uint32 *pAddress, rtk_l2_ipMcastAddr_t *pIpMcastAddr);
 ...
 *      as pAddress to call this API again for dumping all IP multicast entries is LUT.
 */
extern rtk_api_ret_t rtk_l2_ipVidMcastAddr_next_get(uint32 *pAddress, rtk_l2_ipVidMcastAddr_t *pIpVidMcastAddr);
 ...
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_add(ipaddr_t ip_addr, uint32 vid, rtk_portmask_t *pPortmask);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_del(ipaddr_t ip_addr, uint32 vid);
 ...
 *      Delete an entry from IP Multicast group table.
 */
extern rtk_api_ret_t rtk_l2_ipMcastGroupEntry_get(ipaddr_t ip_addr, uint32 vid, rtk_portmask_t *pPortmask);
