 ...
 *     Set a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_set(uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
extern rtk_api_ret_t rtk_vlan_mbrCfg_get(uint32 idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 *
 */
extern rtk_api_ret_t rtk_vlan_checkAndCreateMbr(rtk_vlan_t vid, uint32 *pIndex);
