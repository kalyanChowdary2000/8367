...
typedef struct rtk_igmp_groupInfo_s
{
    ...
    uint32      timer[RTK_PORT_MAX];
    uint32      reportSuppFlag;
 ...
 */
extern rtk_api_ret_t rtk_igmp_maxGroup_set(rtk_port_t port, uint32 group);
 ...
 */
extern rtk_api_ret_t rtk_igmp_maxGroup_get(rtk_port_t port, uint32 *pGroup);
 ...
 */
extern rtk_api_ret_t rtk_igmp_currentGroup_get(rtk_port_t port, uint32 *pGroup);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_leaveTimer_set(uint32 timer);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_leaveTimer_get(uint32 *pTimer);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_queryInterval_set(uint32 interval);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_queryInterval_get(uint32 *pInterval);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_robustness_set(uint32 robustness);
 ...
 * Note:
 */
extern rtk_api_ret_t rtk_igmp_robustness_get(uint32 *pRobustness);
 ...
 *
 */
extern rtk_api_ret_t rtk_igmp_groupInfo_get(uint32 index, rtk_igmp_groupInfo_t *pGroup);
