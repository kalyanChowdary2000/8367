 ...
 */
extern rtk_api_ret_t rtk_trunk_distributionAlgorithm_set(rtk_trunk_group_t trk_gid, uint32 algo_bitmask);
 ...
 */
extern rtk_api_ret_t rtk_trunk_distributionAlgorithm_get(rtk_trunk_group_t trk_gid, uint32 *pAlgo_bitmask);
