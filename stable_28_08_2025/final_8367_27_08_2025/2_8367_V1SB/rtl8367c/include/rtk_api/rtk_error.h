...
typedef enum rt_error_code_e
{
    ...
    /* 0x0001xxxx for vlan */
    RT_ERR_VLAN_VID = 0x0100,                   /* 0x00010000, invalid vid                                                          */
    ...
    RT_ERR_SVLAN_ENTRY_INDEX = 0x0200,          /* 0x00020000, invalid svid entry no                                                */
    ...
    /* 0x0003xxxx for MSTP */
    RT_ERR_MSTI = 0x0300,                       /* 0x00030000, invalid msti                                                         */
    ...
    RT_ERR_TIMESLOT = 0x0400,                   /* 0x00040000, invalid time slot                                                    */
    RT_ERR_TOKEN,                                   /* 0x00040001, invalid token amount                                                 */
    RT_ERR_RATE,                                    /* 0x00040002, invalid rate                                                         */
    RT_ERR_TICK,                                    /* 0x00040003, invalid tick                                                 */

    /* 0x0005xxxx for RMA */
    RT_ERR_RMA_ADDR = 0x0500,                   /* 0x00050000, invalid rma mac address                                              */
    RT_ERR_RMA_ACTION,                              /* 0x00050001, invalid rma action                                                   */

    /* 0x0006xxxx for L2 */
    RT_ERR_L2_HASH_KEY = 0x0600,                /* 0x00060000, invalid L2 Hash key                                                  */
    ...
    RT_ERR_FILTER_BLOCKNUM = 0x0700,            /* 0x00070000, invalid block number                                                 */
    ...
    RT_ERR_ACLRL_HTHR = 0x0800,                 /* 0x00080000, invalid high threshold                                               */
    ...
    RT_ERR_LA_CPUPORT = 0x0900,                 /* 0x00090000, CPU port can not be aggregated port                                  */
    ...
    RT_ERR_SFC_TICK_PERIOD = 0x0a00,            /* 0x000a0000, invalid SFC tick period                                              */
    RT_ERR_SFC_UNKNOWN_GROUP,                       /* 0x000a0001, Unknown Storm filter group                                           */

    /* 0x000bxxxx for pattern match */
    RT_ERR_PM_MASK = 0x0b00,                    /* 0x000b0000, invalid pattern length. Pattern length should be 8                   */
    ...
    RT_ERR_INBW_TICK_PERIOD = 0x0c00,           /* 0x000c0000, invalid tick period for input bandwidth control                      */
    ...
    /* 0x000dxxxx for QoS */
    RT_ERR_QOS_1P_PRIORITY = 0x0d00,            /* 0x000d0000, invalid 802.1P priority                                              */
    ...
    RT_ERR_PHY_PAGE_ID = 0x0e00,                /* 0x000e0000, invalid PHY page id                                                  */
    ...
    RT_ERR_MIRROR_DIRECTION = 0x0f00,           /* 0x000f0000, invalid error mirror direction                                       */
    ...
    /* 0x0010xxxx for stat */
    RT_ERR_STAT_INVALID_GLOBAL_CNTR = 0x1000,   /* 0x00100000, Invalid Global Counter                                               */
    ...
    RT_ERR_DOT1X_INVALID_DIRECTION = 0x1100,    /* 0x00110000, Invalid Authentication Direction                                     */
