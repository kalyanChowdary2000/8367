 ...
 */
extern rtk_api_ret_t rtk_i2c_data_read(uint8 deviceAddr, uint32 slaveRegAddr, uint32 *pRegData);
 ...
 */
extern rtk_api_ret_t rtk_i2c_data_write(uint8 deviceAddr, uint32 slaveRegAddr, uint32 regData);
